...
/*    CURLOPT_USERPWD  => 'cge00503:Paperino03',
    CURLOPT_PROXY => "proxy.cervedgroup.com",
    ...
    return $this->getUrl(
      ...
      array_merge(
        array(
          ...
          'redirect_uri' => 'http://localhost/index.php', // possibly overwritten
          'state' => $this->state,
          'fbconnect'       => 1,
         'return_session'  => 1,
         'next' => 'http://localhost/index.php',
        'session_version' => 3,
